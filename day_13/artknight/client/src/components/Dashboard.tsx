...
// Description: Imports layout icons, animation utility library, and dynamic tailwind class merge helpers.
...
// Description: Declares props expected to render predictions cards list and properties grid view.
...
// Description: Displays model metadata stats, shows the predictions, and maps metric features to grids.
